...
metric_choices = ["eff", "fakerate", "duplrate", "avgOTlen"]
...
def draw_label(params):
    ...
    elif "fakerate" in output_name or "duplrate" in output_name or "avgOTlen" in output_name:
        if "_pt" in output_name:
