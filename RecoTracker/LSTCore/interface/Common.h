...
namespace lst {
  ...
  constexpr unsigned int n_max_pixel_triplets = 5000 * 10;
  constexpr unsigned int n_max_pixel_quintuplets = 15000 * 10;

  constexpr unsigned int n_max_pixel_track_candidates = 300000 * 10;
  constexpr unsigned int n_max_nonpixel_track_candidates = 10000 * 10;
