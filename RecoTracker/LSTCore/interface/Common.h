...
namespace lst {
  ...
  constexpr unsigned int n_max_pixel_segments_per_module = 500000*1;

  constexpr unsigned int n_max_pixel_md_per_modules = 2 * n_max_pixel_segments_per_module;

  constexpr unsigned int n_max_pixel_triplets = 5000*1;
  constexpr unsigned int n_max_pixel_quintuplets = 15000*1;

  constexpr unsigned int n_max_pixel_track_candidates = 300000*1;
  constexpr unsigned int n_max_nonpixel_track_candidates = 10000*1;
