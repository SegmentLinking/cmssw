...
namespace ALPAKA_ACCELERATOR_NAMESPACE::lst {
  ...
  // Approximate uniform CMS solenoid field strength.
  HOST_DEVICE_CONSTANT float kCMSBFieldTesla = 3.8;
  HOST_DEVICE_CONSTANT float k2Rinv1GeVf = (2.99792458e-3 * kCMSBFieldTesla) / 2;
  HOST_DEVICE_CONSTANT float kR1GeVf = 1. / (2.99792458e-3 * kCMSBFieldTesla);
