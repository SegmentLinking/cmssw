...
namespace ALPAKA_ACCELERATOR_NAMESPACE::lst {
  ...
  namespace dnn {
    ...
    namespace t4dnn {
      ...
      HOST_DEVICE_CONSTANT float kWp_displaced[kPtBins][kEtaBins] = {{0.6532, 0.2885, 0.3381,  0.3925, 0.3886, 0.3998,
                                                                      0.5003, 0.4532, 0.3624,  0.5571, 0.4461, 0.3688,
                                                                      0.4487, 0.4183, 0.42073, 0.4718, 0.4004, 0.3037,
                                                                      0.3010, 0.2001, 0.2483,  0.2288, 0.0990, 0.0992,
                                                                      0.0847},  //65 first bin, 85 rest of first 15 bins, 90 rest
                                                                     {0.0245, 0.0330, 0.1931, 0.0502, 0.0179,
                                                                      0.8189, 0.8216, 0.5082, 0.3526, 0.2734,
                                                                      0.4204, 0.0582, 0.0184, 0.1018, 0.0899,
                                                                      0.2338, 0.2594, 0.2093, 0.1854, 0.1399,
                                                                      0.2743, 0.6624, 0.7046, 0.0640, 0.2394}};  //90

      HOST_DEVICE_CONSTANT float
          kWp_fake[kPtBins][kEtaBins] =
              {
                  {0.1999, 0.4224, 0.2946, 0.3265, 0.3264, 0.2734, 0.2478, 0.1879, 0.1520,
                   0.2460, 0.2781, 0.3844, 0.2920, 0.3993, 0.1187, 0.0933, 0.1248, 0.1158,
                   0.1441, 0.0827, 0.0738, 0.0402, 0.0314, 0.0208, 0.0131},  //65 first bin, 80 rest of first 15 bins, 85
                  {0.9115, 0.9605, 0.6660, 0.7374, 0.9263, 0.1698, 0.1485, 0.3590, 0.5302,
                   0.6662, 0.1273, 0.5445, 0.5916, 0.5985, 0.7687, 0.1317, 0.2187, 0.1160,
                   0.4810, 0.1532, 0.3180, 0.0155, 0.0111, 0.1336, 0.1455}};  //90
    }  // namespace t4dnn
