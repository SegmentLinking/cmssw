...
namespace ALPAKA_ACCELERATOR_NAMESPACE::lst {
  ...
  namespace t5dnn {
    ...
    ALPAKA_FN_ACC ALPAKA_FN_INLINE bool runInference(TAcc const& acc,
      ...
      // Layer 1: Linear + Relu
      linear_layer<kinputFeatures, khiddenFeatures>(x, x_1, t5dnn::wgtT_layer1, t5dnn::bias_layer1);
      relu_activation<khiddenFeatures>(x_1);

      // Layer 2: Linear + Relu
      linear_layer<khiddenFeatures, khiddenFeatures>(x_1, x_2, t5dnn::wgtT_layer2, t5dnn::bias_layer2);
      relu_activation<khiddenFeatures>(x_2);

      // Layer 3: Linear + Sigmoid
      linear_layer<khiddenFeatures, 1>(x_2, x_3, t5dnn::wgtT_output_layer, t5dnn::bias_output_layer);
