#ifndef RecoTracker_LSTCore_src_alpaka_Constants_h
#define RecoTracker_LSTCore_src_alpaka_Constants_h
...
#define __H2F
  ...
  // Might be better to switch to using the alpaka_common or ALPAKA_ACCELERATOR_NAMESPACE namespace directly.
