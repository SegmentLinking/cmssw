...
namespace ALPAKA_ACCELERATOR_NAMESPACE::lst {
  ...
  ALPAKA_FN_ACC ALPAKA_FN_INLINE PixelSeedData loadPixelSeedData(PixelSeedsConst pixelSeeds,
    ...
    pixelData.ptIn = pixelSeeds.ptIn()[pixelSegmentArrayIndex];
    pixelData.px = pixelSeeds.px()[pixelSegmentArrayIndex];
    pixelData.py = pixelSeeds.py()[pixelSegmentArrayIndex];
    pixelData.pz = pixelSeeds.pz()[pixelSegmentArrayIndex];
    pixelData.ptErr = pixelSeeds.ptErr()[pixelSegmentArrayIndex];
    pixelData.etaErr = pixelSeeds.etaErr()[pixelSegmentArrayIndex];
    pixelData.eta = pixelSeeds.eta()[pixelSegmentArrayIndex];
    pixelData.phi = pixelSeeds.phi()[pixelSegmentArrayIndex];
    pixelData.charge = pixelSeeds.charge()[pixelSegmentArrayIndex];
    pixelData.circleCenterX = pixelSegments.circleCenterX()[pixelSegmentArrayIndex];
    pixelData.circleCenterY = pixelSegments.circleCenterY()[pixelSegmentArrayIndex];
    pixelData.circleRadius = pixelSegments.circleRadius()[pixelSegmentArrayIndex];
