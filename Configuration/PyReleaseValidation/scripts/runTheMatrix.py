...
if __name__ == '__main__':
    ...
    predefinedSet={
        ...
        'ph2_hlt' : [prefixDet+34.75,    # HLT phase-2 timing menu
                     ...
                     prefixDet+34.7571,  # HLT phase-2 timing menu Alpaka, single tracking iteration, LST seeding + mkFit building variant
                     prefixDet+34.7572,  # HLT phase-2 timing menu Alpaka, single tracking iteration, LST seeding + mkFit building and fitting variant
