...
initialStepT4T5TCLSTTracksMonitoringHLT = trackingMonHLT.clone(
    FolderName       = 'HLT/Tracking/initialStepTracksT4T5TCLST',
    TrackProducer    = 'hltInitialStepTracksT4T5TCLST',
    allTrackProducer = 'hltInitialStepTracksT4T5TCLST'
)
...
(~seedingLST & trackingLST).toReplaceWith(trackingMonitorHLT, cms.Sequence(pixelTracksMonitoringHLT + iterHLTTracksMonitoringHLT + initialSteppTTCLSTTracksMonitoringHLT + initialSteppLSTCLSTTracksMonitoringHLT + initialStepT4T5TCLSTTracksMonitoringHLT + iterHighPtTripletsMonitoringHLT))
(seedingLST & trackingLST).toReplaceWith(trackingMonitorHLT, cms.Sequence(pixelTracksMonitoringHLT + iterHLTTracksMonitoringHLT + initialSteppTTCLSTTracksMonitoringHLT + initialStepT4T5TCLSTTracksMonitoringHLT + highPtTripletSteppLSTCLSTTracksMonitoringHLT))
